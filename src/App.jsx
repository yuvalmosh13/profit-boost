          ...
          <div className="container">
            <div className="about-yuval__grid">
              ...
              <div className="about-yuval__content">
                ...
                <p>
                  יש לי תואר במנהל עסקים וראיית חשבון — אבל המטרה שלי היא לא שתהיי רואת
                  חשבון. המטרה שלי היא שתביני את העסק שלך טוב יותר, תדעי לתמחר נכון יותר,
                  ותדברי על כסף מול לקוחות עם הרבה יותר ביטחון.
                </p>

                <ul className="about-yuval__bullets">
                  <li>בעלת תואר במנהל עסקים וראיית חשבון</li>
